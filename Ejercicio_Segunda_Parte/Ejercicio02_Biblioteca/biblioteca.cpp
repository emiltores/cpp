...
void cargarLibros() {
    ...
    libros[30][2] = "Mark Zuckerberg";

	libros[31][0] = "Python"; 
    libros[31][1] = "Inmersion en Python"; 
    libros[31][2] = "Roberto Torres";

	libros[32][0] = "Python"; 
    libros[32][1] = "Inmersion en Python 3"; 
    libros[32][2] = "Roberto Torres";

	libros[33][0] = "Python"; 
    libros[33][1] = "Introduccion a la programacion con Python"; 
    libros[33][2] = "Steve Jobs";

	libros[34][0] = "Python"; 
    libros[34][1] = "Introduccion a Programacion con Python"; 
    libros[34][2] = "Mark Zuckerberg";

	libros[35][0] = "Python"; 
    libros[35][1] = "Python instantaneo (1999)"; 
    libros[35][2] = "Steve Jobs";

	libros[36][0] = "Python"; 
    libros[36][1] = "Python para ciencia e ingenieria"; 
    libros[36][2] = "Mark Zuckerberg";

	libros[37][0] = "Python"; 
    libros[37][1] = "Python para principiantes"; 
    libros[37][2] = "Roberto Torres";

	libros[38][0] = "Python"; 
    libros[38][1] = "Python para todos"; 
    libros[38][2] = "Mark Zuckerberg";
}
